...
<body>
                      ...
                      <div class="row textDT">
                        <div class="col-xs-2 col-sm-2  col-xs-2 ">
                          ...
                          <div class="col-md-10 col-sm-10 col-xs-10">
                              <h2 class="text-size-300 text-left center-block-absolute display-table padding-top-quarter padding-bottom-quarter margin-none">Habilitação em Libras</h2>
  ...
  <div class="container">
    <!-- Serviços Online --> 
    <div id="servicos-online" class="servicos-online padding-one margin-top-seven center-block black-80 hidden-sm hidden-xs"> 
      ...
      <div class="row">
        ...
        <a href="" class="col-xs-2 text-decoration-none black-80">
          ...
          <span class="text-size-120">Levou multa e está preocupado com a pontuação na Carteira nacional de habilitação?</span>
        </a>
        <a href="#" class="col-xs-2 text-decoration-none black-80">
    ...
    <!-- Form do meio da página com os selects menus -->
      ...
      <div class="row">
        ...
        <div class="fique-por-dentro col-md-7">
          ...
          <span class="black-80 text-size-250 padding-top-one padding-bottom-one  hidden-sm hidden-xs">Fique por Dentro </span> <a href="" class="btn-bt padding-left-one padding-right-one padding-top-halve padding-bottom-halve center-block text-size-120 pull-right margin-half  hidden-sm hidden-xs"><i class="fa fa-plus white padding-right-halve text-size-70" aria-hidden="true"></i>   Noticias</a>
          <!-- Blog Desktop-->
          <div class="row margin-top-two padding-bottom-one padding-left-one padding-right-one hidden-sm hidden-xs">
              ...
              <div id="myCarousel" class="carousel slide carrosel-mobile" data-ride="carousel">
                ...
                <div class="carousel-inner hidden-md hidden-lg">
                  <div class="item active">
                    <a href="" class="col-md-4 padding-halve blog hover"> <img src="assets/images/carro.png"><br>
                      <span class="black-80 text-size-150 text-center container padding-right-three padding-left-three padding-top-one relative">Última semana para licenciar veículos com placa terminada em 7 e caminhões com final 2</span>
                     </a>
                  </div>
                  <div class="item">
                    <a href="" class="col-md-4 padding-halve blog hover"> <img src="assets/images/cidade.png"><br>
                      <span class="black-80 text-size-150 text-center container padding-right-three padding-left-three padding-top-one  relative">Detran.SP investe R$ 8,1 milhões em mais sete cidades para ações de segurança no trânsito</span>
                    </a>
                  </div>                
                  <div class="item">
                    <a href="" class="col-md-4 padding-halve blog hover"> <img src="assets/images/medicos.png"><br>
                      <span class="black-80 text-size-150 text-center container padding-right-three padding-left-three padding-top-one  relative">Detran.SP descobre cobrança indevida para aprovação em exame prático de Taubaté</span>
                    </a>
                  </div>
                </div>
                <!-- Left and right controls -->
            ...
            <a href="#" class="btn-default text-size-120 relative center-block padding-one text-center margin-top-one margin-bottom-one hidden-lg hidden-md"><i class="fa fa-plus white padding-right-halve text-size-70" aria-hidden="true"></i> notícias</a>
          </div>
