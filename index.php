...
<body>
  ...
  <div class="container">
    <!-- Serviços Online --> 
    <div id="servicos-online" class="servicos-online padding-one margin-top-seven center-block black-80"> 
    ...
    <!-- Serviços Online second-line-->
        ...
        <a href=""v class="col-md-2 text-decoration-none black-80">
    ...
    <!-- Form do meio da página com os selects menus -->
      <form class="form-home row border-top-gray border-bottom-gray padding-one margin-top-four">
        ...
        <div class="col-md-2 form-group border-right-gray">
          <span for="txt black-80">Label input texto</span><br>
          <input type="text" class="form-control" id="txt">
        </div>
        <div class="col-md-2 form-group border-right-gray">
          <span for="num black-80">Label input numero</span><br>
          <input type="text" id="UserMobile" maxlength="14" data-fv-numeric="true" data-fv-numeric-message="Please enter valid phone numbers" data-fv-phone-country11="IN" required="required" data-fv-notempty-message="This field cannot be left blank." placeholder="Numero. " class="form-control" name="data[User][mobile]" data-fv-field="data[User][mobile]">
        </div>
        <div class="col-md-2">
