  <div  class="row padding-three relative center-block container margin-top-four">
    <div class="col-md-2 black-80 hidden-xs hidden-xs">
      <ul>  
        ...
        <li><a href="" class="black-50">Educação</a></li>
        <li><a href="" class="black-50">Dique Detran</a></li>
    ...
    <div class="col-md-2 black-80 hidden-xs hidden-xs">
      <ul>  
        ...
        <li><a href="" class="black-50">Transparência</a></li>
        <li><a href="" class="black-50">Estatísticas de Atendimento</a></li>
        <li><a href="" class="black-50">Estatísticas de Trânsito</a></li>
    ...
    <div class="col-md-2 black-80 hidden-xs hidden-xs">
      <ul>  
        ...
        <li><a href="" class="black-50">Código de Ética</a></li>
        <li><a href="" class="black-50">Infrações</a></li>
    ...
    <div class="col-md-1 black-80 hidden-xs hidden-xs">
      <ul>  
        ...
        <li><a href="" class="black-50">Atendimento</a></li>
        <li><a href="" class="black-50">Ouvidoria</a></li>
      </ul>
    </div>
    ...
    <div class="col-md-3 black-80 text-center app-dowload">
      <p class="text-left">Aplicativos para smartphones</p>
      <a href="" alt="google play" > <img src="assets/images/google-play.png" class="pull-left"></a>
      <a href="" alt="apple store">  <img src="assets/images/apple-store.png" class="pull-left"></a><br>
       <a href="" alt="Governo se São Paulo" class="logo"> <img src="assets/images/logo-são-paulo.png" class="pull-left margin-top-three"></a>
    </div>
  </div>
